...
public class Demo2_StackQueue extends BaseConsole{
    ...
    private int click;
    final private ArrayList<String> zodis = new ArrayList<>();
    ...
    private void naudotizodi() {
        zodis.add(readLastLine());
    }
    private void rodytizodi() {
        for (String str : zodis) {
            ta2.appendText(str + nL);
        }
    }
    @Override
    public void createControls() {
        ...
        addButton("Imti zodi", e -> naudotizodi());
        addButton("Rodyti zodi", e -> rodytizodi());
    }
