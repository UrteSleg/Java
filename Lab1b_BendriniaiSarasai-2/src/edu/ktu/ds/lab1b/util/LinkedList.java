...
public class LinkedList<E extends Comparable<E>>
    ...
    public boolean add(int k, E e) {
        ...
        Node<E> e1 = new Node(e, current.next);
        current.next = e1;
        size++;
    ...
    public E set(int k, E e) {
        ...
        Node<E> e1 = new Node<>(e, current.next.next);
        oldValue = current.next.element;
        current.next = e1;
    ...
    public void removeRange(int fromIndex,int toIndex)
    {
        ...
        int k = 0;
        Node<E> temporaryNode = null;
        current = first;
        while (current != null) {
            if (fromIndex == 0 && k <= toIndex) {
                if (k == toIndex) {
                    first = current;
            ...
            else if (k == fromIndex - 1) {
                temporaryNode = current;
                current = current.next;
