...
//        gc.scale(0.975, 0.975);
    ...
    final private EventHandler ehSuite3 = e -> {
        AnoyedFace();
        gc.rotate(vip.turnAngle());
        gc.translate(5, 3);
        gc.scale(0.975, 0.975);
    ...
    private void AnoyedFace(){
        gc.setStroke(Color.YELLOW);
        gc.setLineWidth(1.0);
        gc.strokeLine(0, 0, 0, canvasH/2);
        gc.setFill(Color.BLACK);
        gc.fillOval(40, -canvasH/2+80, 10, 10);
        gc.fillOval(80, -canvasH/2+80, 10, 10);
        gc.fillRect(30, -canvasH/2+110, 80, 10);
    }
    ...
    public void createControls() {
        ...
        addButton("AnoyedFace", e -> { AnoyedFace(); eh = ehSuite3; }); 
