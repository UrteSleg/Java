...
public class ManualTest {
    ...
    public static void executeTest() {
        Car c1 = new Car.Builder().buildRandom();//Car("Renault", "Laguna", 1997, 50000, 1700);
        Car c2 = new Car.Builder().buildRandom();//Car("Renault", "Megane", 2001, 20000, 3500);
        Car c3 = new Car.Builder().buildRandom();//Car("Toyota", "Corolla", 2001, 20000, 8500.8);
        Car c4 = new Car.Builder().buildRandom();//Car("Renault Laguna 2001 115900 7500");
        Car c5 = new Car.Builder().buildRandom();
        Car c6 = new Car.Builder().buildRandom();//Car("Honda   Civic  2007  36400 8500.3");
        Car c7 = new Car.Builder().buildRandom();//Car("Renault Laguna 2001 115900 7500");
...
//        Ks.oun(carsMap.remove(carsIds[7]));
        Ks.oun("Pradiniai duomenys");
        carsMap.println("Porų išsidėstymas atvaizdyje pagal raktus");
//        Ks.oun("Atliekame porų paiešką atvaizdyje:");
//        Ks.oun(carsMap.get(carsIds[2]));
//        Ks.oun(carsMap.get(carsIds[7]));
        // Individualus metodai
        Ks.oun("Vidutinis grandinėlės ilgis:");
        Ks.oun(carsMap.averageChainSize());

 //       Ks.oun("Pradiniai duomenys");
 //       Ks.ounn(carsMap);
 //       Ks.oun("Keiciama verte rakte " + "TA171 i " + c7.toString());

   //     Ks.oun(carsMap.replace("TA171", c7) == null? "Verte ideta i aibe" : "Verte jau egzistuoja");
  //              Ks.oun("Rezultatai");
        //carsMap.println("Porų išsidėstymas atvaizdyje pagal raktus PO PAKEITIMO");
