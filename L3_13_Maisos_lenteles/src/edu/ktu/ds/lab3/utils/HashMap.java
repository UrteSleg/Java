...
public class HashMap<K, V> implements EvaluableMap<K, V> {
    ...
    /**
     * Ideda reiksme i atvaizda jei rakto vietoje nera reiksmes
     *
     * @param key raktas
     * @param value verte
     * @return grazina null jeigu rakto reiksmeje nieko nebuvo arba grazina
     * reiksme kuri yra saugoma rakto vietoj
     */
    
    public java.util.List<V> values(){
        java.util.List<V> val = new ArrayList<>(size);
    ...
    public int averageChainSize(){
        ...
        return totalChainSize / chainsCounter;
    }
